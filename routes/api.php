...
Route::middleware('auth:api')->group( function(){
    ...
    Route::post('profileUpdate',[PatientController::class,'update']);
...
Route::middleware('auth:api')->group( function(){
    ...
    Route::post('deleteSignal',[SignalController::class,'destroy']);

});

Route::middleware('auth:api')->group( function(){
    Route::resource('symptom_users', 'symptom_userController');

    Route::get('symptomData',[symptom_userController::class,'getsymptom']);
    Route::post('symptomStore',[symptom_userController::class,'store']);
    Route::post('symptomUpdate',[symptom_userController::class,'update']);
...
Route::middleware('auth:api')->group( function(){
    ...
    Route::get('connectionRequest',[ConnectionController::class,'showRequest']);
    Route::post('AcceptRequest',[ConnectionController::class,'acceptRequest']);
    Route::post('RejectRequest',[ConnectionController::class,'rejectRequest']);
